...
metric primary: DSC_difficult8 (WORD official difficult group, pre-specified 2026-09-16); cases=20 locked imagesVal; missing arms: none
...
- **DSC_difficult8: UNRELIABLE: mean drop +1.47pp but signs flip across seeds (std 2.50pp)** {'mean_drop_pp': 1.466, 'seed_std_pp': 2.503, 'deltas_pp': [-1.678, -4.42, 1.699], 'n_pairs': 3, 'sign_consistent': False}
...
- mean_fg16: GRAY: drop +1.29pp in -2.0..-1.0pp band, consistent {'mean_drop_pp': 1.287, 'seed_std_pp': 0.302, 'deltas_pp': [-1.667, -1.265, -0.929], 'n_pairs': 3, 'sign_consistent': True}
...
- **DSC_difficult8: NO PHENOMENON: structured BETTER by 1.99pp, sign-consistent (std 1.98pp)** {'mean_drop_pp': -1.991, 'seed_std_pp': 1.979, 'deltas_pp': [0.602, 0.581, 4.79], 'n_pairs': 3, 'sign_consistent': True}
- easy8: UNRELIABLE: mean drop +7.13pp but signs flip across seeds (std 10.07pp) {'mean_drop_pp': 7.135, 'seed_std_pp': 10.072, 'deltas_pp': [2.318, -2.633, -21.089], 'n_pairs': 3, 'sign_consistent': False}
- mean_fg16: UNRELIABLE: mean drop +2.57pp but signs flip across seeds (std 4.07pp) {'mean_drop_pp': 2.572, 'seed_std_pp': 4.073, 'deltas_pp': [1.46, -1.026, -8.149], 'n_pairs': 3, 'sign_consistent': False}
...
- **DSC_difficult8: NO-GO: |drop| 0.76pp < 1.0pp** {'mean_drop_pp': -0.763, 'seed_std_pp': 3.189, 'deltas_pp': [-1.66, -1.319, 5.268], 'n_pairs': 3, 'sign_consistent': False}
...
- mean_fg16: NO-GO: |drop| 0.04pp < 1.0pp {'mean_drop_pp': 0.042, 'seed_std_pp': 1.418, 'deltas_pp': [-0.476, -1.521, 1.87], 'n_pairs': 3, 'sign_consistent': False}
